...
class PaymentSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final modesPaiement = [
      {
        'value': 'VIREMENT',
        'label': l10n.paymentVirementLabel,
        'sub': l10n.paymentVirementSub,
        'icon': Icons.account_balance_outlined,
      },
      {
        'value': 'ESPECES',
        'label': l10n.paymentEspecesLabel,
        'sub': l10n.paymentEspecesSub,
        'icon': Icons.payments_outlined,
      },
      {
        'value': 'MOBILE_MONEY',
        'label': l10n.paymentMobileLabel,
        'sub': l10n.paymentMobileSub,
        'icon': Icons.smartphone_outlined,
      },
    ];

    return Row(
      children: modesPaiement.map((m) {
        final value = m['value'] as String;
        final label = m['label'] as String;
        final sub = m['sub'] as String;
        final icon = m['icon'] as IconData;
        final isSelected = selected == value;
        final isLast = m == modesPaiement.last;
            ...
            child: AnimatedContainer(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(sub, style: TextStyle(fontSize: 11, color: isSelected ? const Color(0xFF2563EB).withValues(alpha: 0.7) : const Color(0xFF94A3B8))),
                ],
              ),
            ),
          ),
